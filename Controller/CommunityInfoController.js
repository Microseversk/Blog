  ...
  async switchPage(param) {
    if (param === GO_NEXT_PAGE) {
      this.#model.currentPage =
        this.#model.currentPage < this.#model.currentPageCount ? this.#model.currentPage + 1 : this.#model.currentPage;
    ...
    window.location.search = buildQuery(this.#view.getFiltersValues(this.#model.currentPage));
  }
}
