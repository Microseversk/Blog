...
class ProfileView {
  ...
  renderProfile(userProfileData) {
    ...
    this.inputBirthDate.value =
      userProfileData.birthDate != null ? userProfileData.birthDate.substring(0, 10) : '';
  ...
  getNewProfileData() {
    ...
    model.birthDate =
      this.inputBirthDate.value.length !== 0
        ? new Date(this.inputBirthDate.value).toISOString()
        : undefined;
    return model;
  }
